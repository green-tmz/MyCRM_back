    ...
    <style>
        ...
        *,
        ...
        .bg-logo {
            ...
            width: 137px;
            margin: 10px auto;
            background-image: url("/storage/images/logo-my-team_black.png");
        }
        ...
        @media (prefers-color-scheme:dark) {
            ...
            .dark\:bg-logo-white {
                ...
                width: 137px;
                margin: 10px auto;
                background-image: url("/storage/images/logo-my-team_white.png");
            }
        }
    </style>
    ...
    <div
        ...
        <div class="max-w-12xl mx-auto sm:px-6 lg:px-8">
            <div class="text-center">
                <div class="bg-logo dark:bg-logo-white"></div>
            </div>
            <div class="ml-12 text-lg leading-7 font-semibold text-center text-gray-700 dark:text-white">
                <h1>Документация по методам API</h1>
                <h3>&laquo;МояCRM&raquo;</h3>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-1">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                <a href="{{ route('l5-swagger.default.api', [], false) }}"
                                    class="underline text-gray-700 dark:text-white">Авторизация / Базовые методы</a>
                            </div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Метод авторизации и базовые методы приложения
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                <a href="{{ route('l5-swagger.users.api', [], false) }}"
                                    class="underline text-gray-700 dark:text-white">Пользователи</a>
                            </div>
                        </div>
